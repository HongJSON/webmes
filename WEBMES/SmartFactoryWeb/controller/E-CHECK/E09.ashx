...
public class E09 : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (funcName)
        {
            ...
            case "UpdateTemplateInfo1":
                ...
                break;
            case "show":
                rtnValue = show(Check_Name, Check_Item, PdlineName, ProjectName, ModelName, ProjectNo, Frequency);
                break;
            case "del":
    ...
    public string show(string Check_Name, string Check_Item, string PdlineName, string ProjectName, string ModelName, string ProjectNo, string Frequency)
    {
        string sql = "";
        if (Check_Name != "" && Check_Name != null && Check_Name != "null")
        {
            sql = sql + " AND A.CHECK_NAME ='" + Check_Name + "'";
        }
        if (Check_Item != "" && Check_Item != null && Check_Item != "null")
        {
            sql = sql + " AND A.CHECK_ITEM ='" + Check_Item + "'";
        }
        ...
        if (Frequency != "" && Frequency != null && Frequency != "null")
        {

            sql = sql + " AND A.FREQUENCY ='" + Frequency + "'";
        }
