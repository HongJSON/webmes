...
public class E07 : IHttpHandler
{
    ...
    public string ShowLabel(string Label)
    {
        ...
        string PROJECT_NAME = LabelName[2];
        ...
        sSQL = $@"SELECT * FROM SAJET.SYS_PROJECT_MODEL_BASE WHERE PDLINE_NAME='{PDLINE_NAME}' AND MODEL_NAME='{MODEL_NAME}' AND PROJECT_NAME='{PROJECT_NAME}'";
