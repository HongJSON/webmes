<%@ WebHandler Language="C#" Class="E07" %>
using System;
using System.Web;
using System.Data;
...
public class E07 : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (funcName)
        {
            ...
            case "UpdateTemplateInfo1L":
                rtnValue = UpdateTemplateInfoL(ProjectNo,PdlineName, ModelName, Remark, Section_Name, isAutoAssy, TemplateQty, Pro, DnNo, user, ID, Type1, Type2, Type3, Type4, Type5, Type6, Type7, Type8, Type9, Type10, Type11, Type12, Check_No, Check_Name, Check_Item, Unit, Check_Qty, Upper, Floor);
                break;
            case "UpdateTemplateInfo1":
                rtnValue = UpdateTemplateInfo(ProjectNo,PdlineName, ModelName, Remark, Section_Name, isAutoAssy, TemplateQty, Pro, DnNo, user, ID, Type1, Type2, Type3, Type4, Type5, Type6, Type7, Type8, Type9, Type10, Type11, Type12, Check_No, Check_Name, Check_Item, Unit, Check_Qty, Upper, Floor);
                break;
            case "Save":
    ...
    public string UpdateTemplateInfo(string ProjectNo, string PdlineName, string Model_name, string Remark, string Section_Name, string isAutoAssy, string TemplateQty, string Pro, string DN_NO, string user, string ID, string Type1, string Type2, string Type3, string Type4, string Type5, string Type6, string Type7, string Type8, string Type9, string Type10, string Type11, string Type12, string Check_No, string Check_Name, string Check_Item, string Unit, string Check_Qty, string Upper, string Floor)
    {
        ...
        if (isAutoAssy == "Y")
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                sSQL = $@"SELECT DISTINCT FREQUENCY FROM   SAJET.SYS_PROJECT_MODEL_BASE WHERE PROJECT_NAME='{Pro}'AND MODEL_NAME='{Model_name}' AND PDLINE_NAME='{PdlineName}'AND PROJECT_NO='{ProjectNo}'";
                ...
                titleMessage += $@"<td style='width: 10%;'>单号</td><td style='width: 10%;'>工站序号</td><td style='width: 10%;'>点检制程</td><td style='width: 10%;'>事项序号</td><td style='width: 10%;'>点检制程名称</td><td style='width: 10%;'>检查事项</td><td style='width: 10%;'>抽检数量</td><td style='width: 10%;'>点检上限</td><td style='width: 10%;'>点检下限</td>";
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    detailMessage += $@"<td>{dt.Rows[i]["PROJECT_NO"]}</td>";
            ...
            public string UpdateTemplateInfoL(string ProjectNo, string PdlineName, string ModelName, string Remark, string Section_Name, string isAutoAssy, string TemplateQty, string Pro, string DN_NO, string user, string ID, string Type1, string Type2, string Type3, string Type4, string Type5, string Type6, string Type7, string Type8, string Type9, string Type10, string Type11, string Type12, string Check_No, string Check_Name, string Check_Item, string Unit, string Check_Qty, string Upper, string Floor)
    {
        ...
        if (isAutoAssy == "Y")
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                sSQL = $@"SELECT DISTINCT FREQUENCY FROM   SAJET.SYS_PROJECT_MODEL_BASE WHERE PROJECT_NAME='{Pro}'AND MODEL_NAME='{ModelName}' AND PDLINE_NAME='{PdlineName}'AND PROJECT_NO='{ProjectNo}'";
                dt = PubClass.getdatatableMES(sSQL);
                ...
                string titleMessage = $@"<table border='1' style='width:80%;text-align:center;word-wrap:break-word;border-collapse:collapse;border: #a8aa44;font-size: 17px;'>
                                   <tr style='background-color:#a8cc44;color: cornsilk;'>";
                titleMessage += $@"<td style='width: 10%;'>单号</td><td style='width: 10%;'>工站项目</td><td style='width: 10%;'>点检制程</td><td style='width: 10%;'>事项序号</td><td style='width: 10%;'>点检制程名称</td><td style='width: 10%;'>检查事项</td><td style='width: 10%;'>抽检数量</td><td style='width: 10%;'>点检上限</td><td style='width: 10%;'>点检下限</td>";
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    titleMessage += $@"<td style='width: 5%;'>{dt.Rows[i]["CHECK_TIME"]}</td>";
                }
                titleMessage += "</tr>";
                string detailMessage = $@"";
                sSQL = $@"SELECT * FROM  SAJET.G_CHECK_WORK_BASE_INFO WHERE NUMBER_ID='{ID}' AND WORK_NO='{DN_NO}'AND PROJECT_NO='{ProjectNo}'";
                dt = PubClass.getdatatableMES(sSQL);
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    detailMessage += $@"<tr style='font-size:13px;'>";
    ...
    public string UpdateTemplateInfoL1(string PdlineName, string ModelName, string Remark, string Section_Name, string isAutoAssy, string TemplateQty, string Pro, string DN_NO, string user, string ID, string Type1, string Type2, string Type3, string Type4, string Type5, string Type6, string Type7, string Type8, string Type9, string Type10, string Type11, string Type12, string Check_No, string Check_Name, string Check_Item, string Unit, string Check_Qty, string Upper, string Floor)
    {
        decimal num = 0; decimal num1 = 0; double MAX = 0; double MIN = 0; string Flag = "N";
        string userEmpId = getEmpIdByNo(user);
        if (userEmpId.Length == 0)
