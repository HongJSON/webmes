...
function GetBuNo() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/E-CHECK/E05.ashx",
...
function Show() {
    ...
    if (dataType == "白班") {
        var url = "../../../controller/E-CHECK/E05.ashx?funcName=show&&Section_Name=" + Section_Name + "&&DnNo=" + DnNo;
...
function insert() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/E-CHECK/E05.ashx",
        data: { ProjectNo:Project_No,PdlineName:PdlineName,Check_No: Check_No, Check_Name: Check_Name, Check_Item: Check_Item, Unit: Unit, Check_Qty: Check_Qty, Upper: Upper, Floor: Floor, ModelName: ModelName, Remark: Remark, Section_Name: Section_Name, isAutoAssy: isAutoAssy, Pro: Pro, DnNo: DnNo, user: user, Type1: Type1, Type2: Type2, Type3: Type3, Type4: Type4, Type5: Type5,ID: ID, funcName: 'UpdateTemplateInfo1' },
        dataType: "json",
        async: false,
        success: function (res) {
            if (res[0].ERR_CODE == "N") {
...
function insert1() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/E-CHECK/E05.ashx",
        data: { ProjectNo: Project_No, PdlineName:PdlineName,ModelName: ModelName, Remark: Remark, Section_Name: Section_Name, isAutoAssy: isAutoAssy,Pro: Pro, DnNo: DnNo, user: user, Type1: Type1, Type2: Type2, Type3: Type3, Type4: Type4, Type5: Type5, Check_No: Check_No, Check_Name: Check_Name, Check_Item: Check_Item, Unit: Unit, Check_Qty: Check_Qty, Upper: Upper, Floor: Floor, ModelName: ModelName, ID: ID, funcName: 'UpdateTemplateInfo1L' },
        dataType: "json",
        async: false,
        success: function (res) {
            if (res[0].ERR_CODE == "N") {
