...
function E04MKeydown(event) {
    ...
    if (event.keyCode == "13") {
        ...
        $.ajax({
            method: "post",
            url: "../../../controller/E-CHECK/E04.ashx",
...
function Add() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/E-CHECK/E04.ashx",
        data: { ProjectNo:ProjectNo, ModelName: ModelName, user: user, ProjectName: ProjectName, PdlineName: PdlineName, Frequency: Frequency,Check_Name: Check_Name, Check_Item: Check_Item, Unit: Unit, Check_Qty: Check_Qty, Upper: Upper, Floor: Floor, funcName: 'Add'
        },
        dataType: "json",
        async: false,
        success: function (res) {
...
function E04PKeydown(event) {
    ...
    if (event.keyCode == "13") {
        ...
        $.ajax({
            method: "post",
            url: "../../../controller/E-CHECK/E04.ashx",
            data: { JJJ: JJJ, funcName: 'ShowTemplate1' },
            dataType: "json",
            async: false,
            success: function (res) {
                if (res != null) {
...
function Show() {
    ...
    var url = "../../../controller/E-CHECK/E04.ashx?funcName=show&&ProjectNo=" + ProjectNo + "&&PdlineName=" + PdlineName + "&&ModelName=" + ModelName + "&&ProjectName=" + ProjectName;
    ...
    $('#table').bootstrapTable({
        ...
        columns: [{ title: 'ID', align: 'center', width: 15, formatter: function (value, row, index) { return index + 1; } },
            ...
            { field: 'PROJECT_NO', title: "工站序号", align: 'center', width: 100, },
            { field: 'CHECK_NAME', title: "点检制程名称", align: 'center', width: 100, },
            { field: 'CHECK_NO', title: "点检制程序号", align: 'center', width: 100, },
...
function insert() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/E-CHECK/E04.ashx",
        data: { ProjectNo:ProjectNo, ModelName: ModelName, user: user, ProjectName: ProjectName, PdlineName: PdlineName, Frequency: Frequency, Check_Name: Check_Name, Check_Item: Check_Item, Unit: Unit, Check_Qty: Check_Qty, Upper: Upper, Floor: Floor, funcName: 'UpdateTemplateInfo1' },
        dataType: "json",
        async: false,
        success: function (res) {
            if (res[0].ERR_CODE == "N") {
    ...
    'click #delete': function (e, value, row, index) {
        ...
        swal({
            ...
            $.ajax({
                url: "../../../controller/E-CHECK/E04.ashx",
                type: "post",
                data: { funcName: 'del', ModelName: row.MODEL_NAME, user: user, NUMBER_ID: row.PROJECT_ID, ProjectName: row.PROJECT_NAME, PdlineName: row.PDLINE_NAME, Check_Name: row.CHECK_NAME, Check_Item: row.CHECK_ITEM, ProjectNo: row.PROJECT_NO, },
                dataType: "json",
                async: false,
                success: function (res) {
                    var error_msg = "";
...
function download() {
    ...
    var tableHtmlEnd = "</tr>";
    var TYPE = "<td align='center'>线体</td><td align='center'>机种</td><td align='center'>制程名称</td><td align='center'>工站序号</td><td align='center'>点检制程名称</td><td align='center'>检查事项</td><td align='center'>单位</td><td align='center'>抽检数量</td><td align='center'>管控上限</td><td align='center'>管控下限</td><td align='center'>点检频率</td>";
...
function importExcel() {
    ...
    $.ajax({
        url: "../../../controller/E-CHECK/E04.ashx?funcName=excel&user=" + user + "&Path=" + files + "",
        type: "POST",
        data: data,
        async: false,
        contentType: false,
