var URLQ03 = "../../../controller/OQC/Q03Controller.ashx";
...
// 不良临时表格删除
function Q11del(lot_id,error_code,ngnum)
{
...
function ShowNG() {
    ...
    jQuery("#jqGridQ11").jqGrid(
		{
		    url: URLQ03 + "?funcName=show&lotid=" + lotid,
		    datatype: 'json',
		    ...
		    colModel: [
                         ...
                         { name: 'NG_NUM', index: 'NG_NUM', width: 80 },
                        {
                            ...
                            formatter: function (cellvalue, options, rowObject) {
                                var detail = "<img  onclick='Q11del(\"" + rowObject.LOT_ID + "\",\"" + rowObject.ERROR_CODE + "\",\"" + rowObject.NG_NUM + "\")' src='../../../img/cal.gif' style='padding:0px 10px'>";
                                return detail;
                            }
                        }
		    ],
        ...
        success: function (value) {
            for (var i = 0; i < value.length; i++) {
                ...
                if (value[i].FLAG == "Nguser") {
                    ...
                    return;
                } if (value[i].FLAG == "NgJig") {
                    alert(value[i].MSG);
                    $("#JigNO").val(""); $("#JigNO").focus();
                    return;
                }
