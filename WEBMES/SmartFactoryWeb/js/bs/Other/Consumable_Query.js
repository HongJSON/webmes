...
function Add() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/Consumable_Query.ashx",
        data: { Remark: Remark, Sn: Sn, Check_Type: Check_Type, ModelName: ModelName, Process_Name: Process_Name, Consumable_Type: Consumable_Type, LabelType: LabelType, PdlineName: PdlineName, funcName: 'Add' },
        dataType: "json",
        async: false,
...
function Consumable_Query(event) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res[0].ERR_CODE == "Y") {
                        ...
                        $('#Consumable_Type').val(Label.split('|')[3]);
                    }
                }
            });
        }
...
function Show() {
    ...
    var url = "../../../controller/OQC-QUALITY/Consumable_Query.ashx?funcName=show&&ModelName=" + ModelName + "&&Process_Name=" + Process_Name + "&&Consumable_Type=" + Consumable_Type + "&&PdlineName=" + PdlineName;
    ...
    $('#table').bootstrapTable({
        ...
        columns: [{ title: 'ID', align: 'center', width: 15, formatter: function (value, row, index) { return index + 1; } },
            ...
            { field: 'OPERATE', title: '刪除', align: 'center', width: 20, events: operateEvents, formatter: addFunctionAlty },]
    });
}
...
window.operateEvents = {
    'click #delete': function (e, value, row, index) {
        ...
        swal({
            ...
            var user = $("#user").text();
            $.ajax({
                url: "../../../controller/Consumable_Query/E03.ashx",
                type: "post",
