...
function Add() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/E10.ashx",
        data: { ProjectNo:ProjectNo,isAutoAssy: isAutoAssy, ModelName: ModelName, user: user, ProjectName: ProjectName, PdlineName: PdlineName, Frequency: Frequency,Check_Name: Check_Name, Check_Item: Check_Item, Unit: Unit, Check_Qty: Check_Qty, Upper: Upper, Floor: Floor, funcName: 'Add'
        },
        dataType: "json",
        async: false,
        success: function (res) {
...
function insert() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/E10.ashx",
        data: { ProjectNo:ProjectNo,isAutoAssy: isAutoAssy, ModelName: ModelName, user: user, ProjectName: ProjectName, PdlineName: PdlineName, Frequency: Frequency, Check_Name: Check_Name, Check_Item: Check_Item, Unit: Unit, Check_Qty: Check_Qty, Upper: Upper, Floor: Floor, funcName: 'UpdateTemplateInfo1' },
        dataType: "json",
        async: false,
        success: function (res) {
            if (res[0].ERR_CODE == "N") {
