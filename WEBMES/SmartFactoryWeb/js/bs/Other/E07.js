...
function GetBuNo() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/E07.ashx",
...
//                            method: "post",
//                            url: "../../../controller/OQC-QUALITY/E07.ashx",
//                            data: { Label: Label, funcName: 'ShowProject1' },
//                            dataType: "json",
//                            async: false,
//                            success: function (res) {
//                                if (res != null) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res[0].ERR_CODE == "Y") {
                        ...
                        $('#PdlineName').val(Label.split('|')[0]);
                        $('#ModelName').val(Label.split('|')[1]);
                        $('#ProjectNO').val(Label.split('|')[2]);
                        $('#ProjectName').val(Label.split('|')[3]);
...
function ShowTempLateQty() {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/E07.ashx",
        data: { ProjectNo: ProjectNo, PdlineName: PdlineName, ModelName: ModelName, ProjectName: ProjectName, funcName: 'ShowTemplateData' },
        dataType: "json",
        async: false,
        success: function (res) {
...
function Show() {
    ...
    if (TemplateQty == 1) {
        var url = "../../../controller/OQC-QUALITY/E07.ashx?funcName=show&&Section_Name=" + Section_Name + "&&DnNo=" + DnNo;
...
window.operateDownEvents = {
    'click #autoAssy': function (e, value, row, index) {
        ...
        GetLabel(row.PROJECT_NO,row.PROJECT_NAME, row.WORK_NO, row.TYPE1, row.TYPE2, row.TYPE3, row.TYPE4, row.TYPE5, row.TYPE6, row.TYPE7, row.TYPE8, row.TYPE9, row.TYPE10, row.TYPE11, row.TYPE12);
    }
}
var Datetime;
function GetLabel(PROJECT_NO,PROJECT_NAME, WORK_NO, TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, TYPE7, TYPE8, TYPE9, TYPE10, TYPE11, TYPE12) {
    ...
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/E07.ashx",
        data: { ProjectNo: PROJECT_NO, PdlineName: PdlineName, ModelName: ModelName, ProjectName: PROJECT_NAME, funcName: 'ShowTemplateData' },
        dataType: "json",
        async: false,
        success: function (res) {
