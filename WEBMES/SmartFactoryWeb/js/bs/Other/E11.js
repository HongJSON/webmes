...
function E11MKeydown(event) {
    ...
    if (event.keyCode == "13") {
        ...
        $.ajax({
            method: "post",
            url: "../../../controller/OQC-QUALITY/E11.ashx",
...
function Show() {
    ...
    var url = "../../../controller/OQC-QUALITY/E11.ashx?funcName=show&&PdlineName=" + PdlineName + "&&ModelName=" + ModelName + "&&ProjectName=" + ProjectName;
...
function importExcel() {
    ...
    $.ajax({
        url: "../../../controller/OQC-QUALITY/E11.ashx?funcName=excel&user=" + user + "&Path=" + files + "",
        type: "POST",
        data: data,
        async: false,
        contentType: false,
