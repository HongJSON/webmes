...
function ShowSECTON_NAME() {
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/E01.ashx",
...
function ShowBu() {
    var Bu = $("#Bu").val();
    var url = "../../../controller/OQC-QUALITY/E01.ashx?funcName=ShowBu&&Bu=" + Bu;
...
function ShowBuName() {
    ...
    var Type = $("#Type").val();
    var BuNo = $("#BuNo").val();
    var url = "../../../controller/OQC-QUALITY/E01.ashx?funcName=ShowBuName&&BuName=" + BuName + "&&Type=" + Type + "&&BuNo=" + BuNo;
    $('#table').bootstrapTable('destroy');
    $('#table').bootstrapTable({
        url: url,
        theadClasses: "bg-light-blue", //設置表頭顏色
