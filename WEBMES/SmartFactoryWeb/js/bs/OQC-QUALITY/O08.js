...
function GetDate() {
    $.ajax({
        method: "post",
        url: "../../../controller/OQC-QUALITY/O08.ashx",
...
function show(Dnno) {
    ...
    if (QTY == 1) {
        var url = "../../../controller/OQC-QUALITY/O08.ashx?funcName=show&&datetimepicker=" + datetimepicker + "&&dataType=" + dataType + "&&DN_NO=" + Dnno + "&&Template=" + Template;
